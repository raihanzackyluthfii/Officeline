    ...
    <table id="datatablesSimple">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><img src='" . $row['gambarkategori'] . "' width='100' height='100'></td>";
                echo "<td>
                <a href='edit.php?id=" . $row['idkategori'] . "' class='btn btn-warning'>Edit</a>
                <a href='delete.php?id=" . $row['idkategori'] . "' class='btn btn-danger' onclick='return confirm(\"Yakin ingin menghapus?\")'>Delete</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
...
<form method="post" enctype="multipart/form-data">
    <div class="modal-body">
        ...
        <br>
        <input type="file" name="gambarkategori" class="form-control" required>
        <br>
